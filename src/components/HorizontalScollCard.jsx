...
const HorizontalScollCard = ({ data = [], heading, trending, media_type }) => {
  ...
  return (
    <div className="container mx-auto px-3 my-10">
      <h2 className="text-xl lg:text-2xl font-bold mb-3 text-white capitalize ml-5 lg:ml-0">
        {heading}
      </h2>
      <div className=" relative">
        <div
          ref={contaierRef}
          className={`${styles.scrollContainer} grid grid-cols-[repeat(auto-fit,235px)] grid-flow-col gap-6 overflow-hidden overflow-x-scroll relative z-10 transition-all`}
        >
          {data.map((data, index) => {
            return (
              <Card
